...
const quoteIndex = new Set();

const generateQuote = function () {
  while (true) {
    let randomQuote = Math.floor(Math.random() * quotes.length);
    console.log(randomQuote);
    if (quoteIndex.has(randomQuote)) continue;

    element.innerHTML = quotes[randomQuote];
    console.log("printed quote: ", randomQuote);
    quoteIndex.add(randomQuote);
    if (quoteIndex.size === quotes.length) quoteIndex.clear();
    break;
  }
};
...
// // 1.
// var global = "global";
// const cannotChange = "never change";
// const myFunc = function () {
//   let small = "small";
//   console.log(global, cannotChange, small);
// };
// console.log(
//   "you can print global, cannotChange but you could not print small",
//   global,
//   cannotChange
// );
// // 2.
